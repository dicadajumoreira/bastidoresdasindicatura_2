...
const VALID_ORIGENS = new Set(['mentoria', 'checklist', 'ebook-ia', 'sindico-profissional', 'sobrevivencia-whatsapp', '50-frases', 'nr1', 'conflitos', 'saude-mental', 'gestao-sob-ataque', 'terceirizados', 'bombeiro', 'politico', 'solitario', 'burocrata', 'estrategista', 'sargento', 'sorteio-mba']);
